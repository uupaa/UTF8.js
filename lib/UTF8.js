...
//{@dev
    Valid(Valid.type(source, "Uint32Array|IntegerArray"), UTF8, "source");
//}@dev
...
function UTF8_fromString(source) { // @arg String
                                   // @ret UTF8OctetString
//{@dev
    Valid(Valid.type(source, "String"), UTF8_fromString, "source");
//}@dev
...
function UTF8_toString(source) { // @arg UTF8OctetString = undefined
                                 // @ret String
//{@dev
    Valid(Valid.type(source, "String|omit"), UTF8_toString, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Uint32Array|IntegerArray"), UTF8_encode, "source");
//}@dev
...
//{@dev
    Valid(Valid.type(source, "Uint8Array|IntegerArray"), UTF8_decode, "source");
//}@dev
